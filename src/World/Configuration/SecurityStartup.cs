...
using company.world.Security.Jwt;
using company.world.Domain.Services;
...
using AuthenticationService = company.world.Domain.Services.AuthenticationService;
using IAuthenticationService = company.world.Domain.Services.Interfaces.IAuthenticationService;
